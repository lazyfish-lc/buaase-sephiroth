...
public class IOSubsystem : MonoBehaviour {
    ...
    void Update() {
        ...
        if (UnityEngine.EventSystems.EventSystem.current.IsPointerOverGameObject() && ActionUI.Instance != null && ActionUI.isOpen && LoadingUI.Instance != null && !LoadingUI.isLoading) {
            dealActionClick();
        }
